 ...
 */
typedef enum {
	HINAWA_SND_UNIT_TYPE_DICE	= SNDRV_FIREWIRE_TYPE_DICE,
	HINAWA_SND_UNIT_TYPE_FIREWORKS	= SNDRV_FIREWIRE_TYPE_FIREWORKS,
	HINAWA_SND_UNIT_TYPE_BEBOB	= SNDRV_FIREWIRE_TYPE_BEBOB,
	HINAWA_SND_UNIT_TYPE_OXFW	= SNDRV_FIREWIRE_TYPE_OXFW,
	HINAWA_SND_UNIT_TYPE_DIGI00X	= SNDRV_FIREWIRE_TYPE_DIGI00X,
	HINAWA_SND_UNIT_TYPE_TASCAM	= SNDRV_FIREWIRE_TYPE_TASCAM,
	HINAWA_SND_UNIT_TYPE_MOTU	= SNDRV_FIREWIRE_TYPE_MOTU,
